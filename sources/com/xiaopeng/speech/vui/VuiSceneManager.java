    ...
    */
    public java.lang.String enterScene(final java.lang.String r6, final java.lang.String r7, boolean r8, final java.lang.String r9) {
        /*
            ...
            goto Le9
        La:
            boolean r2 = com.xiaopeng.speech.vui.utils.VuiUtils.canUseVuiFeature()     // Catch: java.lang.Exception -> Lc2
            if (r2 != 0) goto L11
            return r1
        L11:
            int r2 = r5.getVuiSceneState(r6)     // Catch: java.lang.Exception -> Lc2
            ...
            java.lang.StringBuilder r3 = r3.append(r2)     // Catch: java.lang.Exception -> Lc2
            java.lang.String r4 = ",sceneId:"
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch: java.lang.Exception -> Lc2
            java.lang.StringBuilder r3 = r3.append(r6)     // Catch: java.lang.Exception -> Lc2
            java.lang.String r3 = r3.toString()     // Catch: java.lang.Exception -> Lc2
            com.xiaopeng.speech.vui.utils.LogUtils.logInfo(r0, r3)     // Catch: java.lang.Exception -> Lc2
            com.xiaopeng.speech.vui.model.VuiSceneState r3 = com.xiaopeng.speech.vui.model.VuiSceneState.INIT     // Catch: java.lang.Exception -> Lc2
            int r3 = r3.getState()     // Catch: java.lang.Exception -> Lc2
            r4 = 0
            if (r2 != r3) goto L4d
            if (r8 == 0) goto L43
            r5.cleanExpiredSceneTime(r6)     // Catch: java.lang.Exception -> Lc2
        L43:
            com.xiaopeng.speech.vui.model.VuiSceneState r2 = com.xiaopeng.speech.vui.model.VuiSceneState.ACTIVE     // Catch: java.lang.Exception -> Lc2
            int r2 = r2.getState()     // Catch: java.lang.Exception -> Lc2
            r5.updateSceneState(r6, r2)     // Catch: java.lang.Exception -> Lc2
            goto L88
        L4d:
            com.xiaopeng.speech.vui.model.VuiSceneState r3 = com.xiaopeng.speech.vui.model.VuiSceneState.UNACTIVE     // Catch: java.lang.Exception -> Lc2
            int r3 = r3.getState()     // Catch: java.lang.Exception -> Lc2
            if (r2 != r3) goto L69
            boolean r2 = r5.isNeedBuild(r6)     // Catch: java.lang.Exception -> Lc2
            if (r2 == 0) goto L5c
            goto L5d
        L5c:
            r4 = r1
        ...
        L67:
            ...
            goto Lc4
        L69:
            com.xiaopeng.speech.vui.model.VuiSceneState r3 = com.xiaopeng.speech.vui.model.VuiSceneState.IDLE     // Catch: java.lang.Exception -> Lc2
            int r3 = r3.getState()     // Catch: java.lang.Exception -> Lc2
            if (r2 != r3) goto L78
            java.lang.String r2 = "未注册场景信息，场景数据将不能使用"
            com.xiaopeng.speech.vui.utils.LogUtils.e(r0, r2)     // Catch: java.lang.Exception -> Lc2
            goto L87
        L78:
            com.xiaopeng.speech.vui.model.VuiSceneState r3 = com.xiaopeng.speech.vui.model.VuiSceneState.ACTIVE     // Catch: java.lang.Exception -> Lc2
            int r3 = r3.getState()     // Catch: java.lang.Exception -> Lc2
            if (r2 != r3) goto L87
            boolean r2 = r5.isNeedBuild(r6)     // Catch: java.lang.Exception -> Lc2
            if (r2 == 0) goto L87
    ...
    public boolean isUploadScene(String str) {
        ...
        if ((this.mIsInSpeech && VuiEngineImpl.mActiveSceneIds.containsValue(str) && (VuiConstants.SETTINS.equals(this.mPackageName) || VuiConstants.CARCONTROL.equals(this.mPackageName) || "com.xiaopeng.chargecontrol".equals(this.mPackageName) || VuiConstants.UNITY.equals(this.mPackageName))) || VuiConstants.CENTER.equals(this.mPackageName)) {
            return true;
        }
