...
public class EventDispatcher implements Runnable {
    ...
    public void dispatch(String str, String str2) {
        ...
        if (vuiScene == null) {
            ...
            if (VuiUtils.is3DApp(VuiSceneManager.instance().getmPackageName())) {
                ...
                boolean booleanValue = (VuiConstants.SYSTEMUI.equals(VuiSceneManager.instance().getmPackageName()) || (tag = findView2.hitView.getTag(R.id.customDoAction)) == null) ? false : ((Boolean) tag).booleanValue();
    ...
    private boolean callOnVuiEvent(VuiElement vuiElement, final VuiEventInfo vuiEventInfo) {
        ...
        if (VuiElementType.STATEFULBUTTON.getType().equals(vuiElement.getType()) && !VuiConstants.SYSTEMUI.equals(VuiSceneManager.instance().getmPackageName())) {
    ...
    private boolean isCustomHandle(VuiElement vuiElement, View view) {
        ...
        if (vuiElement.getProps() == null || (props = vuiElement.getProps()) == null || !props.has(VuiConstants.PROPS_DISABLECONTROL)) {
            return (view == null || VuiConstants.SYSTEMUI.equals(VuiSceneManager.instance().getmPackageName()) || view.getTag(R.id.customDisableControl) == null) ? false : true;
        }
    ...
    private boolean isCustomFeedback(VuiElement vuiElement, View view) {
        return (view == null || VuiConstants.SYSTEMUI.equals(VuiSceneManager.instance().getmPackageName()) || view.getTag(R.id.customDisableFeedback) == null) ? false : true;
    }
}
