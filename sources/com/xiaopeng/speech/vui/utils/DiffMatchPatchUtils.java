...
public class DiffMatchPatchUtils {
    ...
    */
    ...
    protected LinesToCharsResult diff_linesToChars(String str, String str2) {
        ...
        arrayList.add("");
        return new LinesToCharsResult(diff_linesToCharsMunge(str, arrayList, hashMap, 40000), diff_linesToCharsMunge(str2, arrayList, hashMap, SupportMenu.USER_MASK), arrayList);
    }
